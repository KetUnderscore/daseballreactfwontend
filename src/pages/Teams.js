                            ...
                            osteamData?.map( (item) => {
                                return (
                                    <div className='team-link'>
                                        ...
                                        <a href={'http://localhost:3000/team/'+item.teamName} value={item._id} key={item.teamName}><h3>{ item.teamEmoji }{ item.teamName }</h3></a><span><h3>W | { item.gamesWon } L | { item.gamesLost }</h3></span>
                                        </div>
                                    </div>
                                )
                            })
