                                    ...
                                    return (
                                        <div className='game-holder'>
                                            ...
                                            <div className='game-panel'>
                                                ...
                                                <p className='split-para-old'>Pitcher <span>{(item.topOfinning == true) ? item.homeTeam.teamEmoji : item.awayTeam.teamEmoji}<a style={{color: item.topOfinning == true ? "#"+item.awayTeam.teamColor : "#"+item.homeTeam.teamColor}} href={'http://daseball.netlify.app/player/'+item.currentPitcher.name}>{item.currentPitcher.name}</a></span></p>
                                                <p className='split-para-old'>Batter <span>{(item.topOfinning == true) ? item.awayTeam.teamEmoji : item.homeTeam.teamEmoji}<a style={{color: item.topOfinning == true ? "#"+item.homeTeam.teamColor : "#"+item.awayTeam.teamColor}} href={'http://daseball.netlify.app/player/'+item.currentBatter.name}>{item.currentBatter.name}</a></span></p>
                                            </div>
                                            <div className='game-panel'>
                                                <p>
