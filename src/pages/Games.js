                                    ...
                                    return (
                                        <div className='game-holder'>
                                            ...
                                            <div className='game-panel'>
                                                ...
                                                <p className='split-para-old'>Pitcher <span>{item.currentPitcher.teamEmoji}<a style={item.topOfInning ? {color: "#"+item.awayTeam.teamColor} : {color: "#"+item.homeTeam.teamColor}} href={'http://daseball.netlify.app/player/'+item.currentPitcher.name}>{item.currentPitcher.name}</a></span></p>
                                                <p className='split-para-old'>Batter <span>{item.currentBatter.teamEmoji}<a style={item.topOfInning ? {color: "#"+item.homeTeam.teamColor} : {color: "#"+item.awayTeam.teamColor}} href={'http://daseball.netlify.app/player/'+item.currentBatter.name}>{item.currentBatter.name}</a></span></p>
                                            </div>
                                            <div className='game-panel'>
                                                <p>
