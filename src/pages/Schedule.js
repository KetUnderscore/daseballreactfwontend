                    ...
                    for (let gn = 0; gn < teamLength; gn += 2) {
                        ...
                        setDayOneSched(dayOneSched => [...dayOneSched, 
                            ...
                            <div>
                                ...
                                { seasonData[0].weather[daysLeft][0+(gn/2)] === 6 ? <img src="https://i.imgur.com/hec6F8s.png" height="20px" className="weather" title="Sunder" alt='Sunder'></img> : ''}
                                { seasonData[0].weather[daysLeft][0+(gn/2)] === 7 ? <img src="https://i.imgur.com/IOlPsA2.png" height="20px" className="weather" title="Moon" alt='Moon'></img> : ''}
                            </div>
                    ...
                    for (let gn = 0; gn < seasonData[0].postSeasonSchedule[daysLeft].length; gn += 2) {
                        ...
                        setDayOneSched(dayOneSched => [...dayOneSched, 
                            ...
                            <div>
                                ...
                                { seasonData[0].postSeasonWeather[daysLeft][0+(gn/2)] === 6 ? <img src="https://i.imgur.com/hec6F8s.png" height="20px" className="weather" title="Sunder" alt='Sunder'></img> : ''}
                                { seasonData[0].postSeasonWeather[daysLeft][0+(gn/2)] === 7 ? <img src="https://i.imgur.com/IOlPsA2.png" height="20px" className="weather" title="Moon" alt='Moon'></img> : ''}
                            </div>
