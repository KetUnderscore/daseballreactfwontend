...
function Schedule() {
    ...
    const loadDays = async () => {
        if (seasonData != null && seasonData[0].scheduleTeamInfo.length > 0) {
            setDaysLoaded(true)
            let teamLength = 12
            let teamSlotA = 0
            let teamSlotB = 0
            ...
            for (let daysLeft = seasonData[0].seasonDay; daysLeft < seasonData[0].schedule.length; daysLeft++) {
                for (let gn = 0; gn < teamLength; gn += 2) {
                    ...
                    setDayOneSched(dayOneSched => [...dayOneSched, 
                        ...
                        {daysLeft >= 45 ?
                        <div>
                            { seasonData[0].postSeasonWeather[daysLeft-45][0+(gn/2)] === 0 ? <img src="https://i.imgur.com/yvlrdat.png" height="20px" className="weather" title="Null" alt='Null'></img> : ''}
                            { seasonData[0].postSeasonWeather[daysLeft-45][0+(gn/2)] === 1 ? <img src="https://i.imgur.com/MX8RFc4.png" height="20px" className="weather" title="Sunny" alt='Sunny'></img> : ''}
                            { seasonData[0].postSeasonWeather[daysLeft-45][0+(gn/2)] === 2 ? <img src="https://i.imgur.com/K3DWIqZ.png" height="20px" className="weather" title="Shuffle" alt='Shuffle'></img> : ''}
                            { seasonData[0].postSeasonWeather[daysLeft-45][0+(gn/2)] === 3 ? <img src="https://i.imgur.com/YDH7LQT.png" height="20px" className="weather" title="Waves" alt='Waves'></img> : ''}
                            { seasonData[0].postSeasonWeather[daysLeft-45][0+(gn/2)] === 4 ? <img src="https://i.imgur.com/FfuBnBD.png" height="20px" className="weather" title="Coffee" alt='Coffee'></img> : ''}
                            { seasonData[0].postSeasonWeather[daysLeft-45][0+(gn/2)] === 5 ? <img src="https://i.imgur.com/NBMbLYO.png" height="20px" className="weather" title="Skipping" alt='Skipping'></img> : ''}
                        </div>
                        : 
                        <div>
