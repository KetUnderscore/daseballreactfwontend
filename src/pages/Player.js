                            ...
                            {  playerData[0]?.modifiers.map( (item) => {
                                return (
                                    <span> 
                                        ...
                                        { item.name === "Icon+" ? <img src="https://i.imgur.com/9jU25eY.png" height="30px" title="This player is an icon+. Tripled favorite payouts!"></img> : '' }
                                        ...
                                        { item.name === "Precognition" ? <img src="https://i.imgur.com/xCk0rVZ.png" height="30px" title="This player can see a better future."></img> : '' }
                                        { item.name === "Trader" ? <img src="https://i.imgur.com/qIl8Jji.png" height="30px" title="This player wants to trade!"></img> : '' }

                                        { item.name === "Zodiac" ? <img src="https://imgur.com/qJlX78M" height="30px" title="This player is a zodiac player."></img> : '' }
                            ...
                            <h2>Mods | {  playerData[0]?.item.modifiers.map( (item) => {
                                return (
                                    <span> 
                                        ...
                                        { item.name === "Data Breach" ? <img src="https://i.imgur.com/ROhdf21.png" height="20px" title="This player is breaking!"></img> : '' }
                                        { item.name === "Patched" ? <img src="https://i.imgur.com/ar8A2xZ.png" height="20px" title="This player has been patched."></img> : '' }
                                        ...
                                        { item.name === "Team Pillar" ? <img src="https://i.imgur.com/GXCcMj0.png" height="20px" title="This player is a team pillar! They are immune!"></img> : '' }
                                    </span>
                                )}) 
                            }</h2>
