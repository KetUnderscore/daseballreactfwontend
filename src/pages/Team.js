                                ...
                                pitchingData?.map( (item) => {
                                    return (
                                        <div className='player-link'>
                                            ...
                                            {playerDetailedData != false ? "★".repeat(Math.max(0, (Math.floor((item.praying + item.publicity + item.pope) / 99)))) + "☆".repeat(Math.max(0, ((Math.round((item.praying + item.publicity + item.pope) / 99)) - (Math.floor((item.praying + item.publicity + item.pope) / 99))))) +"(" + (Math.floor(((item.praying + item.publicity + item.pope)/99)*10) / 10).toFixed(1).toString() +")" : ''}
