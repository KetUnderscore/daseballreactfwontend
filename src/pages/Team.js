                                ...
                                pitchingData?.map( (item) => {
                                    return (
                                        <div className='player-link'>
                                            ...
                                            {playerDetailedData != false ? "★".repeat(Math.max(0, (Math.floor((item.praying + item.publicity + item.pope) / 99)))) + "☆".repeat(Math.max(0, ((Math.round((item.praying + item.publicity + item.pope) / 99)) - (Math.floor((item.praying + item.publicity + item.pope) / 99))))) +"(" + (Math.floor(((item.praying + item.publicity + item.pope)/99)*10) / 10).toString() +")" : ''}
                                ...
                                battingData?.map( (item) => {
                                    ...
                                    return (
                                        <div className='player-link'>
                                            ...
                                            {playerDetailedData != false ? "★".repeat(Math.max(0, Math.floor(statstotal / 297))) + (statstotal % 297 >= 148.5 ? '☆' : '') + "(" + (Math.floor((statstotal/297)*10) / 10).toString() +")" : ''}
                                            {playerHiddenData != false ? item.modifiers.map( (item) => {
                                                return (
                                                    modify(item, 1)
                                                )
                                ...
                                pocketData?.map( (item) => {
                                    ...
                                    return (
                                        <div className='player-link'>
                                            ...
                                            {playerDetailedData != false ? "★".repeat(Math.max(0, Math.floor(statstotal / 396))) + (statstotal % 396 >= 198 ? '☆' : '') + "(" + (Math.floor(((statstotal)*10)/396) / 10).toString() +")" : ''}
                                            {playerHiddenData != false ? item.modifiers.map( (item) => {
                                                return (
                                                    modify(item, 1)
                                                )
